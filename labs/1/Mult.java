...
// Author:  Seth Roller
// Date:    1/18/18
// Purpose: Lab 1 will demonstrate Javas input and output functions
//
// Specification:
	...
	public static void main(String args[]) 
     {
		...
		System.out.println();
		System.out.println();
		System.out.println("Twice " + aNumber + " is " + 2 * aNumber + ",");
		System.out.print("        ");
		System.out.println("and four times is " + 4 * aNumber + ",");
		System.out.print("        ");
		System.out.println("and eight times is " + 8 * aNumber);
		System.out.println();
		System.out.println();
	}
}
